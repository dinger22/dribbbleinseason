    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_SHOT_IMAGE:
                ...
                //view.setOnTouchListener(ShotActivity.onSwipeTouchListener());
...
//
                Drawable bucketDrawable = shot.bucketed
                        ? ContextCompat.getDrawable(getContext(), R.drawable.ic_archive_white_24dp)
                        : ContextCompat.getDrawable(getContext(), R.drawable.ic_archive_black_24dp);
